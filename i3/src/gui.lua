...
local function get_inventory_fs(player, data, fs)
	...
	--	fs"style[player_model;bgcolor=black]"
		...
		-- Edit Skin side button (left panel, under player model)
	fs("style[edit_skin_open;fgimg=edit_skin_button.png;fgimg_hovered=edit_skin_button.png;content_offset=0]")
	image_button(0.2, ctn_hgt - 0.9, 0.5, 0.5, "", "edit_skin_open", "")
	fs("tooltip[edit_skin_open;Edit Skin;#32333899;#fff]")
